# Onec-offer — коммерческое предложение 1С.ЭДО.Легаси

Статический лендинг с коммерческим предложением по приложению **1С.ЭДО.Легаси** (интеграция учётной системы с оператором ЭДО Доки, «Астрал»).
